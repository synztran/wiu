  ...
  return (
    <Menu as="div" className="relative inline-block text-left">
      ...
      <Transition
        ...
        enterFrom='tranform opacity-0 scale-95'
        enterTo='transform opacity-100 scale-100'
        leave='transition ease-in duration-75'
        leaveFrom='transform opacity-100 sacle-100'
      ...
      >
        <Menu.Items className="absolute right-0 z-10 mt-2 w-56 origin-top-right rounded-md border border-zinc-400 dark:border-zinc-700 bg-orange-50 dark:bg-zinc-800 shadow-xl ring-1 ring-black ring-opacity-5 focus:outline-none divide-zinc-400 dark:divide-zinc-700  ">
          <div className='py-1'>
            <div className='px-3 py-2 uppercase font-bold text-xl'>
              Cateogories
            </div>
            ...
            <DropdownMenuItem href="/categories/videography">Videography</DropdownMenuItem>
          </div>
        </Menu.Items>
      </Transition>
    </Menu>
